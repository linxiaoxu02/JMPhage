...
<p align="center">
  <a href="https://doi.org/10.5281/zenodo.20838733">
    <img src="https://img.shields.io/badge/Zenodo-JMPhage%20Database-blue" alt="JMPhage Database">
  </a>
  <a href="https://doi.org/10.5281/zenodo.21374471">
    <img src="https://img.shields.io/badge/Test%20Dataset-Minimal-brightgreen" alt="JMPhage Minimal Test Dataset">
  </a>
  <a href="https://doi.org/10.5281/zenodo.21186527">
    <img src="https://img.shields.io/badge/Test%20Dataset-Full-orange" alt="JMPhage Full Test Dataset">
  </a>
...
Two test datasets are available for JMPhage v1.0. For quick installation checks and basic testing, users are encouraged to begin with the lightweight JMPhage Minimal Test Dataset. The JMPhage Full Test Dataset provides additional test cases and representative outputs from different JMPhage analysis modes.
...
Two test datasets are available on Zenodo:

| Dataset | Description | Zenodo |
|:--|:--|:--|
| **JMPhage Minimal Test Dataset** | Contains genome assemblies and paired-end sequencing reads for two phages. Recommended for quick installation checks and basic workflow testing. No precomputed outputs are included. | [10.5281/zenodo.21374471](https://doi.org/10.5281/zenodo.21374471) |
| **JMPhage Full Test Dataset** | Contains single-phage and multi-phage test cases, together with selected reference outputs from different JMPhage analysis modes. | [10.5281/zenodo.21186527](https://doi.org/10.5281/zenodo.21186527) |

New users are encouraged to begin with the Minimal Test Dataset. The Full Test Dataset can be used to examine representative JMPhage outputs and test additional analysis modes.
...
```
<p align="center"> <img src="img/depth_plot.png" alt="Sequencing-depth profile generated by JMPhage" width="900"> </p> <p align="center"> <sub>Example sequencing-depth profile generated by the JMPhage mapping module.</sub> </p>
...
<p align="center"> <img src="img/genome.png" alt="Circular genome maps generated by JMPhage" width="1200"> </p> <p align="center"> <sub>Example circular genome maps generated by the annotation module of JMPhage.</sub> </p>
...
<p align="center"> <img src="img/Genome synteny plot.png" alt="Genome synteny plots generated by JMPhage" width="1200"> </p> <p align="center"> <sub>Example Genome synteny plots generated by the characterization module of JMPhage.</sub> </p>
...
```
<p align="center"> <img src="img/ANI_heatmap.png" alt="Pairwise intergenomic similarity heatmap generated by JMPhage" width="1200"> </p> <p align="center"> <sub>Example Pairwise intergenomic similarity heatmaps generated by the characterization module of JMPhage.</sub> </p>
...
<p align="center"> <img src="img/Z90_tree.png" alt="Phylogenetic tree generated by JMPhage" width="1200"> </p> <p align="center"> <sub>Example Phylogenetic trees generated by the characterization module of JMPhage.</sub> </p>
...
<p align="center">
  <img src="img/combine_tree.png" alt="Joint small phylogenetic tree generated from multiple input phages by JMPhage" width="1200">
</p>

<p align="center">
  <sub>Example joint small phylogenetic tree generated from multiple input phage genomes in JMPhage multi-phage mode.</sub>
</p>
